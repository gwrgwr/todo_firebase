...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(0xffd0eac0),
      ...
      tertiaryFixed: Color(0xffd0eac0),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff647b58),
      ...
      tertiaryFixed: Color(0xff647b58),
  ...
  static MaterialScheme darkScheme() {
    return const MaterialScheme(
      ...
      onTertiaryContainer: Color(0xffd0eac0),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      tertiaryContainer: Color(0xffb8d2a9),
      onTertiaryContainer: Color(0xff000000),
      ...
      tertiaryFixedDim: Color(0xffb8d2a9),
